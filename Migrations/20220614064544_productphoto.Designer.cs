...
namespace App.mvc.net.Migrations
{
    ...
    [Migration("20220614064544_productphoto")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("app.models.Product.photo.ProductPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.mvc.net.Contacts.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mvcblog.Models.CategoryProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Product_categoryProduct", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Product_categoryProduct");
                });
            ...
            modelBuilder.Entity("mvcblog.Models.CategoryProduct", b =>
                {
                    b.HasOne("mvcblog.Models.CategoryProduct", "ParentCategory")
                        .WithMany("CategoryChildren")
                        .HasForeignKey("ParentCategoryId");
            ...
            modelBuilder.Entity("Product_categoryProduct", b =>
                {
                    b.HasOne("mvcblog.Models.CategoryProduct", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
