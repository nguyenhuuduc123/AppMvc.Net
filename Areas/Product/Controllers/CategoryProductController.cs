...
namespace App.mvc.net
{
    ...
    public class CategoryProductController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var qr = (from c in _context.CategoryProducts select c).Include(c => c.ParentCategory)
        ...
        private void CreateSelectListIteam(List<CategoryProduct> source,List<CategoryProduct> des,int lv){
